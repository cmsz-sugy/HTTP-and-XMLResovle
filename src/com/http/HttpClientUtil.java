...
public class HttpClientUtil {  
    ...
    public static void main(String[] args) {  
        ...
        params.put("commands", "pricelist");  
        params.put("username", "client");  
        params.put("sign", "1875199d092b39be5261105ecbcc4022"); 
        System.out.println(HttpClientUtil.doPost("http://testapi.mobilepulsa.com/receiver/index.php", params, "utf-8"));  
    }  
}  